...
# Part 2 - Configuring Snort3 on Ubuntu

Prerequisites
A fresh Linux installation (Ubuntu/Debian-based distros recommended)
Basic knowledge of Linux command-line interface
Root access to the Linux system
Snort3 already installed on your system, but not yet configured
